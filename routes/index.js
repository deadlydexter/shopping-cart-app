...
router.get('/shopping-cart', function (req, res, next) {
  if (!req.session.cart) {
    return res.render('shop/shopping-cart', { products: null, title: 'Buy Cars | Shopping Cart Page' });
  }
  var cart = new Cart(req.session.cart);
  res.render('shop/shopping-cart', { products: cart.generateArray(), totalPrice: cart.totalPrice, title: 'Buy Cars | Shopping Cart Page' })
})
...
router.get('/checkout', isLoggedIn, function (req, res, next) {
  ...
  res.render('shop/checkout', { total: cart.totalPrice, errMsg: errMsg, noError: !errMsg, title: 'Buy Cars | Checkout Page' });
});
